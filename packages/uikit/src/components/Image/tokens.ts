/**
 * @see https://github.com/Reaconswap/Reacon-frontend/blob/develop/src/config/constants/tokens.ts
 */
const tokens = {
  cake: {
    symbol: "CAKE",
    ...
    decimals: 18,
    projectLink: "https://Reaconswap.finance/",
  },
  txl: {
    symbol: "TXL",
    address: {
  ...
  bunny: {
    ...
    decimals: 18,
    projectLink: "https://Reaconbunny.finance/",
  },
  alice: {
    symbol: "ALICE",
    address: {

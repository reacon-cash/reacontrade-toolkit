...
export interface ReaconToggleProps extends InputHTMLAttributes<HTMLInputElement> {
  scale?: Scales;
  checked?: boolean;
}
...
export const scaleKeys = {
  ReaconSize: "ReaconSize",
  travelDistance: "travelDistance",
  toggleHeight: "toggleHeight",
  toggleWidth: "toggleWidth",
  ReaconThickness: "ReaconThickness",
  ReaconTwoOffset: "ReaconTwoOffset",
  ReaconThreeOffset: "ReaconThreeOffset",
  butterTop: "butterTop",
